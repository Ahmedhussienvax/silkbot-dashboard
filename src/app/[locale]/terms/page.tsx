                ...
                <div className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 gap-12 text-slate-400">
                        <section className="space-y-6">
                            <h2 className="text-2xl font-black text-white italic uppercase tracking-tight">1. Operational Mandate</h2>
                        ...
                        <section className="space-y-6">
                            <h2 className="text-2xl font-black text-white italic uppercase tracking-tight">2. Data Sovereignty</h2>
                            <p className="leading-relaxed font-medium">
                        ...
                        <section className="space-y-6">
                            <h2 className="text-2xl font-black text-white italic uppercase tracking-tight">3. Forbidden Architectures</h2>
                            <p className="leading-relaxed font-medium">
                    ...
                    <div className="pt-20 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 bg-white/[0.02] border border-white/5 rounded-3xl group hover:border-accent-primary/30 transition-all">
