                ...
                <div className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-12">
                        {[
                            ...
                            <div key={i} className="p-8 glass-card border border-border hover:border-pink-500/30 transition-all flex flex-col justify-between group cursor-pointer">
                                <div className="space-y-4">
                                    ...
                                    <h3 className="text-2xl font-black text-foreground italic uppercase tracking-tighter group-hover:text-pink-500 transition-colors leading-tight">{post.title}</h3>
                                    <p className="text-xs font-bold text-muted-foreground opacity-80">{post.desc}</p>
                                </div>
                                <button className="mt-8 px-6 py-2 bg-surface border border-border rounded-xl text-[10px] font-black uppercase hover:bg-pink-500 hover:text-foreground transition-all w-fit">Read Log</button>
                            </div>
                        ))}
                    </div>
                </div>
