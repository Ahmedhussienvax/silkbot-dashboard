...
// Highly efficient, pure CSS based loading pulse for instant feedback.
export default function Loading() {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#030410] z-[9999]">
      <div className="flex flex-col items-center gap-6">
        {/* Animated Branding Pulse */}
        <div className="relative">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-indigo-400 flex items-center justify-center shadow-2xl animate-pulse ring-1 ring-white/10">
