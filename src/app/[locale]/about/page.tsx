            ...
            <div className="w-full max-w-4xl px-8 py-20 flex-1">
                ...
                <div className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="glass-card p-10 border-white/5 bg-white/[0.02] flex flex-col gap-6">
                            <Target className="w-8 h-8 text-accent-primary" />
                            <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">Core Mission</h3>
                            <p className="text-sm text-slate-500 leading-relaxed font-medium">To provide businesses with autonomous communication agents that bridge the gap between deterministic logic and human nuance.</p>
                        </div>
                        <div className="glass-card p-10 border-white/5 bg-white/[0.02] flex flex-col gap-6">
                            <Users className="w-8 h-8 text-accent-secondary" />
                            <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">The Collective</h3>
                            <p className="text-sm text-slate-500 leading-relaxed font-medium">Built by a global network of engineers dedicated to open neural standards and secure data propagation.</p>
                        </div>
                    </div>
                </div>
            </div>
