                    ...
                    <div className="space-y-10">
                        {[
                            ...
                            <div key={i} className="flex gap-8 group">
                                <div className="w-16 h-16 rounded-[1.5rem] bg-surface border border-border flex items-center justify-center group-hover:border-accent-primary/50 transition-all shrink-0">
                                    <item.icon className="w-6 h-6 text-accent-primary" />
                                </div>
                                <div className="space-y-2 pt-2">
                                    <h3 className="text-xl font-black text-foreground uppercase italic tracking-tighter">{item.title}</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed font-bold uppercase tracking-widest italic">{item.content}</p>
                                </div>
                            </div>
                        ))}
                    </div>
