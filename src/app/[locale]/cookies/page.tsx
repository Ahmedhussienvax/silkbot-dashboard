                ...
                <div className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 gap-12 text-muted-foreground">
                        <section className="space-y-6">
                            <h2 className="text-2xl font-black text-foreground italic uppercase tracking-tight">1. Why We Use Cookies</h2>
                        ...
                        <section className="space-y-6">
                            <h2 className="text-2xl font-black text-foreground italic uppercase tracking-tight">2. Necessary Cookies</h2>
                            <p className="leading-relaxed font-medium">
                        ...
                        <section className="space-y-6">
                            <h2 className="text-2xl font-black text-foreground italic uppercase tracking-tight">3. User Control</h2>
                            <p className="leading-relaxed font-medium">
                    ...
                    <div className="pt-20 border-t border-border grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 bg-surface border border-border rounded-3xl group hover:border-amber-500/30 transition-all">
