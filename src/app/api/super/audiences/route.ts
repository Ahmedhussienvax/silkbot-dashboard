...
export async function GET(req: NextRequest) {
    ...
    // 3. Forward request query params to backend Gateway API
    const url = new URL(req.url);
    const backendUrl = new URL(`${gUrl}/api/super/audiences`);
    backendUrl.search = url.search; // Retain filtering params
